...
table(["Area", "What it provides"], [
    ...
    ["Checklists", "Trackable project plans (Networking DC↔AWS; Control Tower/OU/Accounts/Env/VPC; MGN VM migration) with owners, effort, dependencies, critical-path Gantt, and CSV/Markdown export"],
